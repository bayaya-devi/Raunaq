...
Object.assign(translations.ar, {
  brand: { name: '????' },
  nav: { shop: '????', benefits: '???????', ingredients: '????????', faq: '???????', contact: '?????', cta: '???? ????' },
  hero: { eyebrow: '?????? ??????', title: '????? ?????? ??????? ????? ??????', copy: '???? ????? ????? ?????? ???? ?????? ??? ?????? ???? ????.', buy: '???? ??????', learn: '????? ????????' },
  trust: { natural: '?????? ??????', jar: '???? ?????', preservatives: '???? ?????' },
  buy: { rating: '????? ?????? ????? ??????? ??????', title: '?????? ??????? ????', copy: '???? ??? ? ??????? ?????? ??????. ???? ?????? ?? ??? ???? ??????.', price: '??? ????', oldPrice: '??? ????', qty: '??????', button: '???? ????', note: '', notice: '?????: ??? ?????? ??? ???? ??? ???? ?? ??????? ???? ??? ???? ???? ????.' },
  benefits: { kicker: '????? ?????', title: '????? ????? ???? ???? ????? ????', copy: '????? ???? ????? ???? ??? ?????? ???? ??????? ?????? ?????.' },
  cards: { a: { title: '??????? ????????', copy: '?????? ????? ???? ?????? ??????? ???????? ??????.' }, b: { title: '???? ???????', copy: '??? ???? ??????? ?????? ???? ???? ????? ???.' }, c: { title: '????? ?????', copy: '?????? ?????? ???????? ?? ?????? ??????? ??????.' }, d: { title: '??? ???????', copy: '?????? ?????? ??????? ?????? ??????.' } },
  ingredients: { kicker: '?????? ????', title: '?????? ?????? ?????? ??????', copy: '????? ???? ???????? ???? ????? ????? ?????? ??? ??????.', b1: '???? ???? ?????', b2: '???? ????? ??????', b3: '???? ??????', warning: '???? ?? ???? ???? ????? ????? ?? ?????? ???????.' },
  pack: { kicker: '???????', title: '????? ???? ????? ????', copy: '??? ?????? ?????? ???? ???? ?????? ???? ????? ????? ????? ??? ????? ???? ??????.', b1: '???? ??? ?', b2: '????? ???????', b3: '????? ?????' },
  faq: { kicker: '??? ?????', title: '????? ????', q1: '??? ???? ???????', a1: '???? ???? ????? ???? ???????? ????? ????? ???? ??????.', q2: '?? ?????? ?????', a2: '??. ?? ???? ????? ????? ??? ??? ?????? ????? ???.', q3: '?? ???? ????? ??? ?????????', a3: '???? ????? ???? ???????? ???? ??????? ??????? ??????? ??????.' },
  contact: { kicker: '????? ?????', title: '???? ???? ??? ?????? ???????', copy: '???? ???? ??????? ???????? ????????? ?? ??????? ???????.' },
  social: { whatsapp: '??????', instagram: '????????', facebook: '??????', tiktok: '??? ???' },
  order: { kicker: '??? ????', title: '????? ?????', copy: '???? ??????? ?????? ?????. ???? ??? ???? ????? ????? ??? ??? ??? ??????.', name: '????? ??????', phone: '??????', city: '??????? / ?????', note: '?????? ????????', summary: '??????', submit: '????? ?????', success: '?? ????? ?????. ??????: ', error: '???? ????? ?????.' },
  chat: { button: '??????', subtitle: '????? ???????', placeholder: '???? ?????...', send: '?????', hello: '?????? ??? ????? ????. ?????? ??????? ?? ?????? ?????? ???????? ?? ???????.', fallback: '???? ???????. ????? ????? ????? ??? ??? ?????? ?? ????? ????? ?? ??????? ??? ??????.', price: '????? ?????? ?? ??? ???? ?????? ??? ?.', order: '???? ???? ????? ???? ??????? ?? ???? ????? ??????? ????????.' },
  sticky: { title: '???? ??? ?', copy: '?????? ??????? ????? ?????', button: '???? ????' },
  footer: { copy: '? ???? ????. ???? ?????? ??????.' }
});
Object.assign(translations.fr, { brand: { name: 'RAUNAQ' }, social: { whatsapp: 'WhatsApp', instagram: 'Instagram', facebook: 'Facebook', tiktok: 'TikTok' } });
Object.assign(translations.en, { brand: { name: 'RAUNAQ' }, social: { whatsapp: 'WhatsApp', instagram: 'Instagram', facebook: 'Facebook', tiktok: 'TikTok' } });
Object.assign(translations.es, { brand: { name: 'RAUNAQ' }, social: { whatsapp: 'WhatsApp', instagram: 'Instagram', facebook: 'Facebook', tiktok: 'TikTok' } });
...
function updateOrderSummary(){if(!orderSummary||!qty)return;const t=currentTranslation();orderSummary.textContent=select.value==='ar'?`???? ??? ? ? ${normalizeQuantity()} - ${t.buy.price}`:`RAUNAQ 250g x ${normalizeQuantity()} - ${t.buy.price}`}
